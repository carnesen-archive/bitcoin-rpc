...
function Request(opts) {
  opts = opts || {};
  this.id = opts.id || bitcore.crypto.Random.getPseudoRandomBuffer(8).toString('hex');
...
Request.prototype.serialize = function() {
  var obj = {
    method: this.method.name.toLowerCase(),
    params: this.method.params.serialize.bind(this.method.params)(this.args)
  };
